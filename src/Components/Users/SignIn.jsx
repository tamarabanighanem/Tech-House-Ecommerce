          ...
          <div class="mt-12 flex flex-col items-center">
            ...
            <div class="w-full flex-1 mt-8">
              <div class="flex flex-col items-center">
                ...
                <button
                  class="sign-with-account w-full  max-w-xs font-bold shadow-md rounded-lg py-3 bg-indigo-100 text-gray-800 flex items-center justify-center hover:shadow-teal-600  transition duration-300 focus:shadow-none focus:translate-y-0.5 focus:scale-110 hover:-translate-y-1 hover:scale-110 mt-5"
                >
