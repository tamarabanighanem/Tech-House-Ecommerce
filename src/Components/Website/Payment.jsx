...
export default function payment() {
  ...
  return (
    ...
    >
      <div className="w-full pt-1 pb-5">
        <div className="bg-teal-600 text-white overflow-hidden rounded-full w-20 h-20 -mt-16 mx-auto shadow-lg flex justify-center items-center p-10">
         payment page
        </div>
      </div>
      <div className="mb-10">
  ...
  <input type="text" name="name" value={name} />
        ...
        <button  type='submit' className="block w-full max-w-xs mx-auto bg-teal-600 hover:bg-teal-800 text-white rounded-lg px-3 py-3 font-semibold">
        <Link to="/Confirmation"> PAY NOW</Link> 
        </button> </form>
      </div>
    </div>
  </div>
