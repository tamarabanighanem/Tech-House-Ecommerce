...
export default function ProductDetails() {
    ...
    const dataDetails = data.filter(item => item.id == params.id)
  ...
  <li className="flex items-center space-x-3">
    ...
    Stock : {" "}
      ...
      {dataDetails[0].stock}
          ...
          <a  name={dataDetails.id} onClick={handleCartClick}
            className="cursor-pointer text-white bg-teal-600 hover:bg-teal-200 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
            Go To Cart
          </a>
            </div>
          </div>
